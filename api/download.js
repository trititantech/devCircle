...
export default async function handler(req, res) {
  ...
  try {
    ...
    } else if (movieName === "Amazon") {
      // For Amazon software download
      const version = "v2.1.8";
      filename = `Amazon_Software_Update_${version}.exe`;
    } else if (movieName === "DeviceCircle") {
      // For Device Circle catalog download
      const version = "v3.2.1";
      filename = `DeviceCircle_Inventory_Catalog_${version}.exe`;
    } else {
